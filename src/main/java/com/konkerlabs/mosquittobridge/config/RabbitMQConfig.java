...
public class RabbitMQConfig {
    ...
    @Bean
    public Queue dataSubQueue() {

       boolean durable = true;
       boolean exclusive = false;
       boolean autoDelete = false;

       return new Queue("data.sub", durable, exclusive, autoDelete);

    }

    @Bean
    public Queue configSubQueue() {

       boolean durable = true;
       boolean exclusive = false;
       boolean autoDelete = false;

       return new Queue("mgmt.config.sub", durable, exclusive, autoDelete);
